            ...
            <div class="container">
                <div class="hero-content">
                    <div class="hero-text">
                        ...
                        <p class="hero-subtitle">Premium custom printing services with exceptional quality and fast
                            delivery in Indonesia.</p>
                    </div>
                    <div class="hero-image">
                        <img src="{{ asset('images/wil.jpg') }}"
            ...
            <div class="container">
                <div class="contact-content">
                    <div class="contact-info">
                        <h2 class="contact-title">SiberStore HQ</h2>

                        <div class="info-grid">
                            <div class="info-item">
                                <h3>Contact Info</h3>
                                <div class="info-details">
                                    <p class="phone">+62 21 - 55123456</p>
                                    <p class="email">hello@siberstore.com</p>
                                </div>
                            </div>
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-details">
                                    ...
                                    <p>& 127 Creative District Jakarta</p>
                                    <p>Jakarta Selatan</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="social-section">
                        <h2 class="social-title">We are on Socials</h2>
